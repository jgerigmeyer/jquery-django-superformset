(function($) {
    ...
    test('calls addDeleteTrigger with template and options.canDelete', function (assert) {
    ...
    test('calls addDeleteTrigger with (options.canDelete && !options.deleteOnlyNew)', function () {
        this.formlist.superformset();
    ...
    test('calls activateAddTrigger if options.autoAdd is falsy', function () {
        this.formlist.superformset();

        ok(this.methods.activateAddTrigger.calledOnce, 'activateAddTrigger was called once');
    });

    test('does not call activateAddTrigger if options.autoAdd is truthy', function () {
        this.formlist.superformset({autoAdd: true});

        ok(!this.methods.activateAddTrigger.called, 'activateAddTrigger was not called');
    });

    test('calls autoAddRow if options.alwaysShowExtra && options.autoAdd are truthy', function () {
        this.formlist.superformset();
    ...
    test('if options.addTriggerSel is missing, appends options.addTrigger to wrapper', function () {
    ...
    test('animates display of new row if options.addAnimationSpeed', function () {
    ...
    test('calls options.addedCallback with new row', function (assert) {
    ...
    test('does nothing if options.optionalIfEmpty is falsy or row is not options.optionalIfEmpty', function () {
    ...
    test('if canDelete, calls options.removedCallback with row on deleteTrigger click', function () {
    ...
    test('does nothing if options.insertAbove is falsy', function () {
    ...
    test('does not remove :required from inputs where data-required-by !== options prefix', function () {
